...
<head>
    ...
    <style>
        ...
        * {{ box-sizing: border-box; }}
        ...
        .commodity-sidebar-title {{ color: #fff; font-size: 26px; font-weight: 900; letter-spacing: 0; }}
        .commodity-sidebar-count {{ color: #8b909c; font-size: 20px; font-weight: 850; }}
        ...
        .commodity-group-title {{ color: #8b909c; font-size: 16px; font-weight: 900; letter-spacing: 0.1em; text-transform: uppercase; padding: 0 16px 10px; }}
        .commodity-link {{ display: grid; grid-template-columns: minmax(0, 1fr) auto; align-items: center; gap: 14px; min-height: 48px; padding: 0 16px; border-radius: 7px; color: #d7dae2; text-decoration: none; font-size: 18px; font-weight: 900; margin: 0 0 8px; }}
        ...
        .commodity-code {{ color: #8b909c; font-size: 18px; font-weight: 900; }}
